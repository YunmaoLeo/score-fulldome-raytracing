...
public:
    ...
    VkImageLayout render(QVulkanInstance *inst,
    ...
    void setCamera(const QVector3D& position, const QVector3D& center, float fov, int projectionMode);
private:
